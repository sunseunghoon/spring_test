 ...
 */
public class RollingFileRecreateAppender<E> extends FileAppender<E> {
    ...
    public RollingFileRecreateAppender() {
        super();
    }
    ...
    public void setFile(String file) {
        System.out.println("RollingFileRecreateAppender.file = "+file);
...
//            writeBytes(byteArray);
    ...
    protected void writeOut(E event) throws IOException {
        if (!Files.exists(Paths.get(getFile()))) {
            openFile(getFile()); // recreates file
            FileNotFoundException e=new FileNotFoundException("Log file not found : "+getFile());
            addStatus(new ErrorStatus("Log file not found", this, e));
        }
